...
g.hist.cor.t = ggplot(data = result, aes(x = correlation)) + geom_histogram()
ggsave( "Figures/histogram_of_correlation_between_lcWGS_vs_GSA_across_traits.png", g.hist.cor.t, width = 8, height = 6)
...
![](Figures/histogram_of_correlation_between_lcWGS_vs_GSA_across_traits.png)
...
result.c.samples = data.frame(result.c.samples)

g.hist.cor.s = ggplot(data = result.c.samples, aes(x = correlation)) + geom_histogram()
ggsave( "Figures/histogram_of_correlation_between_lcWGS_vs_GSA_across_samples.png", g.hist.cor.s, width = 8, height = 6)

```

![](Figures/histogram_of_correlation_between_lcWGS_vs_GSA_across_samples.png)
...
```{r, fig.height=13, fig.width=12, eval = F}
...
![](Figures/SupFig2_lcWGS_vs_GSAvs_binary_traits.jpeg)
...
![](Figures/SupFig2_lcWGS_vs_GSAvs_quantitative_traits.jpeg)
...
![](Figures/SupFig2_lcWGS_vs_GSAvs_35BM.jpeg)
...
![](Figures/SupFig2_lcWGS_vs_GSAvs_FattyAcid_traits.jpeg)
...
![](Figures/SupFig2_lcWGS_vs_GSAvs_PPP.jpeg)


### per person plot


```{r, fig.height=16, fig.width=12, eval = F}
...
![](Figures/SupFig2_lcWGS_vs_GSAvs_per_person.jpeg)
...
g.outliers = ggplot(data = melted.SALSA[melted.SALSA$variable %in% result[which(result$correlation < 0.9), "variable"],], aes(x = GSAv2, y = LPS)) + 
  geom_point(size = 0.1) + 
  facet_wrap(~variable, ncol = 4) + 
  xlim(-3,3) + ylim(-3,3)

ggsave("Figures/outlier_traits_correlation_between_lcWGS_vs_GSA.jpeg", g.outliers, width = 12, height = 4)
```

![](Figures/outlier_traits_correlation_between_lcWGS_vs_GSA.jpeg)
