...
Whole genome sequencing data is downloaded from the 1000 Genomes project, which did the high-coverage wgs. 
...
The files are alignment files, which were against the human genome build 38. 
