...
We used the tool [qsubshcom](https://github.com/zhilizheng/qsubshcom) to pipeline the steps and customized for our server. The detailed steps and parameters are explained here. 
